...
const Navbar = () => {
  ...
  return (
    <header className="flex flex-col md:flex-row items-center justify-between px-3 sm:px-4 md:px-8 py-3 sm:py-4">
      {/* Logo and Title */}
      <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4 md:mb-0">
      ...
      <div className="flex flex-col md:flex-row items-center gap-3 sm:gap-4 md:gap-8">
        ...
        {/* Phone Numbers */}
        <div className="flex flex-col sm:flex-row md:flex-row items-center space-y-1 sm:space-y-0 sm:space-x-4 md:space-x-6">
          {/* Phone Number 1 */}
        ...
        {/* Theme Toggle */}
        <div className="mx-auto my-auto text-xl sm:text-2xl border-2 border-transparent rounded-full hover:bg-main-8">
