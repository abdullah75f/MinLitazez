...
const Home = () => {
  return (
    <div>
      <h2
        className="mt-5 mb-5 text-5xl font-bold text-center text-blue-500"
        style={{ fontFamily: "Dancing Script, cursive" }}
      >
        Coming Soon!!!
      </h2>
      <h2
        className="mb-5 text-5xl font-bold text-center text-yellow-500"
      ...
      <div>
        <h3
          className="mt-5 mb-5 text-3xl font-bold text-center text-black"
          style={{ fontFamily: "Lobster, cursive" }}
        >
      ...
      <div className="flex justify-center mt-10 space-x-6">
        <a
          href="https://www.instagram.com/minlitazezaddis2020/"
          target="_blank"
          ...
          onClick={(e) => {
            ...
            window.location.href =
              "instagram://user?username=minlitazezaddis2020";
            setTimeout(() => {
              window.location.href =
                "https://www.instagram.com/minlitazezaddis2020/";
            }, 30000);
          }}
        >
        ...
        <a
          href="https://t.me/MinLetazezAddis"
          target="_blank"
          rel="noopener noreferrer"
          className="transition-transform transform hover:scale-110"
          onClick={(e) => {
        ...
        <a
          href="https://www.tiktok.com/@minletazez?lang=en"
          target="_blank"
          rel="noopener noreferrer"
          className="transition-transform transform hover:scale-110"
          onClick={(e) => {
            ...
            setTimeout(() => {
              window.location.href =
                "https://www.tiktok.com/@minletazez?lang=en";
            }, 30000);
          }}
        >
        ...
        <a
          href="https://web.facebook.com/MinLetazez2020"
          target="_blank"
          rel="noopener noreferrer"
          className="transition-transform transform hover:scale-110"
          onClick={(e) => {
        ...
        <a
          href="https://www.youtube.com/@MinLitazezTrading"
          target="_blank"
          rel="noopener noreferrer"
          className="transition-transform transform hover:scale-110"
          onClick={(e) => {
            e.preventDefault();
            window.location.href =
              "vnd.youtube://www.youtube.com/channel/UC1234567890";
            setTimeout(() => {
              window.location.href =
                "https://www.youtube.com/@MinLitazezTrading";
            }, 30000);
          }}
        >
        ...
        <a
          ...
          className="transition-transform transform hover:scale-110"
        >
          <FaPhone className="text-4xl text-gray-700 hover:text-green-500" />
        </a>
        <a
          href="tel:+21717443050"
          className="transition-transform transform hover:scale-110"
        >
          <FaPhone className="text-4xl text-gray-700 hover:text-green-500" />
        </a>
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-500">
        {isStarted ? "Checkout" : "Coming Soon"}
      </p>
    </div>
  );
};
