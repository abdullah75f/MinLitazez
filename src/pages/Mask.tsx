  ...
  return (
    <div className="relative py-16 min-h-screen flex items-center justify-center bg-fixed bg-gray-900">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center text-white">
        <h1 className="mb-6 text-3xl sm:text-5xl font-extrabold tracking-wide text-blue-300">
        ...
        <div className="p-6 sm:p-8 bg-blue-100 bg-opacity-95 rounded-2xl shadow-2xl">
          ...
          />
          <p className="text-2xl sm:text-4xl font-semibold text-blue-900 mb-2 sm:mb-3">
