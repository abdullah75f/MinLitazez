...
const Mask = () => {
  return (
    <div className="relative py-16 min-h-screen flex items-center justify-center bg-fixed bg-gray-900 font-sans">
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center text-white">
        <h1 className="mb-6 text-4xl sm:text-6xl font-bold tracking-wide text-blue-300">
        ...
        <div className="p-6 sm:p-8 bg-blue-100 bg-opacity-95 rounded-2xl shadow-2xl">
          ...
          />
          <p className="text-3xl sm:text-5xl font-bold text-blue-900 mb-2 sm:mb-3">
            Order Your Guyya Facemask Now!
          </p>
          <p className="text-2xl sm:text-4xl font-medium text-blue-900 mb-2 sm:mb-3">
            ጭምብልዎን ይሸምቱ ፤ <br />
            ደህነትዎን ይጠብቁ!
          </p>

          <p className="text-lg sm:text-2xl font-light text-blue-800 mb-4 sm:mb-6">
            Get yours today and stay protected.
          </p>

          {/* Clickable phone numbers with improved styling */}
          <div className="mb-3 sm:mb-4">
            <p className="text-xl sm:text-2xl font-semibold text-blue-700 mb-2">
              Call on the below numbers
            </p>
            <div className="flex flex-col space-y-2">
              <a
                href="tel:+251937389909"
                className="text-lg sm:text-xl bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-blue-700 transition font-medium"
              >
                0937389909
              </a>
              <a
          ...
          <div className="mb-3 sm:mb-4">
            ...
            <a
              ...
              className="text-lg sm:text-xl bg-green-600 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-700 transition font-medium"
            >
